...
const RoundedButtonText = styled.Text.attrs<ButtonTextProps>(
  (props: { selected: any }) => ({
...
const RoundedButton = ({ style, selected = false, children }: ButtonProps) => (
  <TouchableHighlight style={style} underlayColor="rgba(245,219,227,0.8)">
    <RoundedButtonText selected={selected}>{children}</RoundedButtonText>
  </TouchableHighlight>
);
