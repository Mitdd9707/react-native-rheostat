      ...
      />
       ...
       { handlePos &&  (
          <Animated.View
            ...
            key={`handle-`}
          ><View style={{flex:1,display:'flex',alignItems:'center'}}><Text>43</Text></View>
           <View style={{height: 40, borderStyle: 'dotted', borderLeftWidth: 4,display:'flex',alignItems:'center',marginLeft:13,bottom:5}}></View>
            <View style={{height:30}}><Handle style={[Style.handle]} theme={theme} /></View>
          </Animated.View>
        )
      }
      <View
